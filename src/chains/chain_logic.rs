...
pub fn get_rpc_endpoint(chain_select: chains) -> String {
    ...
    match chain_select {
        chains::Polkadot => "wss://polkadot-rpc.dwellir.com:443".to_string(),
        chains::Hydradx => "wss://hydradx-rpc.dwellir.com:443".to_string(),
        chains::Interlay => "wss://interlay-rpc.dwellir.com".to_string(),
        chains::Assethub => "wss://polkadot-asset-hub-rpc.polkadot.io:443".to_string(),
    }
}
